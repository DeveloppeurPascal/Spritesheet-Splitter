...
Découpe une spritesheet (largeur/hauteur identique, éventuellement avec un décalage en largeur ou en hauteur) en images indépendantes (sprites ou autres).
...
Vous pouvez aussi [consulter le site du logiciel](https://spritesheetsplitter.olfsoftware.fr/) pour en savoir plus sur son fonctionnement, accéder à des vidéos et articles, connaître les différentes versions disponibles et leurs fonctionnalités, contacter le support utilisateurs...

## Installation des codes sources

Pour télécharger ce dépôt de code il est recommandé de passer par "git" mais vous pouvez aussi télécharger un ZIP directement depuis [son dépôt GitHub](https://github.com/DeveloppeurPascal/Spritesheet-Splitter).
...
Si vous voulez une réponse du propriétaire de ce dépôt la meilleure façon de procéder pour demander une nouvelle fonctionnalité ou signaler une anomalie est d'aller sur [le dépôt de code sur GitHub](https://github.com/DeveloppeurPascal/Spritesheet-Splitter) et [d'ouvrir un ticket](https://github.com/DeveloppeurPascal/Spritesheet-Splitter/issues).
